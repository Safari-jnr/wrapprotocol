...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-surface-950/50 backdrop-blur-xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-bold text-base text-white">{PROJECT_NAME}</span>
            </Link>
            <p className="text-xs text-white/30 leading-relaxed max-w-xs">
              Your gateway to Web3. Track wallets, discover dApps, and participate in airdrops across EVM and Solana.
            </p>
            {/* Social icons */}
      ...
      <div className="border-t border-white/5 py-5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-white/10">
            Built on EVM + Solana &middot; The smart contract is the source of truth.
          </p>
        </div>
      </div>
    </footer>
