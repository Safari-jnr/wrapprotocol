// ─── Airdrop — Shared Constants ────────────────────────────────────────────────
// Update these before mainnet / devnet deploy. Everything else references these.

export const PROJECT_NAME = "Wrap Protocol";
export const TOKEN_SYMBOL = "WRAP";
export const TOKEN_DECIMALS = 18;

// How many tokens each wallet receives per claim
...
export const AIRDROP_TOKEN_ADDRESS =
  (process.env.NEXT_PUBLIC_AIRDROP_TOKEN_ADDRESS as `0x${string}`) ??
  "0x0000000000000000000000000000000000000000";
